...
public class InsightService {
  ...
  public InsightDto getSavingTips(Long userId) {
    ...
    double totalUsage = usageData.devices().stream().mapToDouble(DeviceDto::energyConsumed).sum();
    ...
    ChatResponse response = ollamaChatModel.call(Prompt.builder().content(prompt).build());
  ...
  public InsightDto getOverview(Long userId) {
    ...
    String prompt =
        new StringBuilder()
            .append(
                "Analyze the following energy usage data and provide a concise overview with actionable insights to reduce consumption.\n")
