...
public class ParallelDataSimulator implements CommandLineRunner{
    ...
    public void sendMockData() {
        ...
        log.info("Dispatched {} mock data requests across {} threads.", requestsPerInterval, parallelThreads);
    }
    ...
    public boolean start() {
        ...
        synchronized (scheduleLock) {
            ...
            scheduledTask = scheduler.scheduleAtFixedRate(this::sendMockData, 0, intervalMs, TimeUnit.MILLISECONDS);
